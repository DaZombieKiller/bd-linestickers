...
lineemotes.prototype.getLocalizationStrings = function () {
  ...
  if (locale === 'ja') {
    localization_strings['bda-qem-emojis'] = '???',
    localization_strings['bda-qem-favourite'] = '?????'
    localization_strings['addform-title'] = '????',
    localization_strings['addform-length'] = '??????',
    localization_strings['addform-id'] = '???????ID',
    localization_strings['addform-add'] = '??',
    localization_strings['delete-confirm'] = '?????????????',
    localization_strings['yes'] = '??',
    localization_strings['no'] = '???'
  }
